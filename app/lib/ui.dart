...
StatusStyle statusOf(String? s) =>
    statusStyles[s] ??
    StatusStyle(s ?? '?', Rm.inkSoft, Rm.paper3, Rm.inkFaint);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            s.label,
            style: sans(size: 12, weight: FontWeight.w600, color: s.deep),
          ),
        ],
      ),
    );
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              if (!_down)
                BoxShadow(
                  color: Rm.pearDeep.withValues(alpha: 0.25),
                  blurRadius: 10,
...
/// Hallmark · component: GPU meter row · genre: playful · theme: Hum
/// states: display-only · responsive: 320/375/414/768
/// GPU/资源横条:mono 标签 + 等宽圆角条 + 固定数值列。
class MeterRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          final valueWidth = constraints.maxWidth < 280 ? 122.0 : 138.0;
          return Row(
            children: [
              SizedBox(
                width: 52,
              ...
              Expanded(
                child: RmProgress(value: fraction, color: Rm.pear, height: 6),
              ),
